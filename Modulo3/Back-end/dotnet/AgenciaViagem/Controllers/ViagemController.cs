...
namespace dotnet.Controllers
{
    public class ViagemController : Controller
    {
        ...
        public ViagemController(DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID_Viagem,Partida,Destino,Origem")] Viagem viagem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID_Viagem,Partida,Destino,Origem")] Viagem viagem)
        {
